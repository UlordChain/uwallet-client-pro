...
from uwallet.bitcoin import RECOMMENDED_FEE
from uwallet import coinchooser
...
class SettingsDialog(Factory.Popup):
    ...
    def __init__(self, app):
        ...
        self.config = self.app.uwallet_config
    ...
    def coinselect_status(self):
        return coinchooser.get_name(self.app.uwallet_config)
