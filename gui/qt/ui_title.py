...
class Ui_titleWD(object):
    def setupUi(self, titleWD,parent):
        ...
        # htitleLable = QtGui.QLabel("                           U")
        # htitleLable.setStyleSheet("font-family: \"Arial\";font:bold;font-size:15px;border-bottom: 2px solid #FFD100;color:yellow;")
        # titleLabel = QtGui.QLabel("Wallet"+ parent.get_version())
        # titleLabel.setStyleSheet("font-family: \"Arial\";font:bold;font-size:15px;border-bottom: 2px solid #FFD100;color:yellow;")
        # self.horizontalLayout_5.addWidget(htitleLable)
        # self.horizontalLayout_5.addWidget(titleLabel)
