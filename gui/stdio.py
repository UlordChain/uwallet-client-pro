...
from uwallet.util import format_satoshis, set_verbosity, StoreDict
from uwallet.bitcoin import is_valid, COIN, TYPE_ADDRESS
from uwallet.network import filter_protocol
...
class UWalletGui:
    ...
    def network_dialog(self):
        print("use 'uwallet setconfig server/proxy' to change your network settings")
        return True
