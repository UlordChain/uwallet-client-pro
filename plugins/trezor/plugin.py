...
from uwallet.bitcoin import (bc_address_to_hash_160, xpub_from_pubkey,
                              public_key_to_bc_address, EncodeBase58Check,
                              TYPE_ADDRESS, TYPE_SCRIPT)
from uwallet.i18n import _
from uwallet.plugins import BasePlugin, hook
from uwallet.transaction import deserialize, Transaction
from uwallet.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
...
class TrezorCompatibleKeyStore(Hardware_KeyStore):
    ...
    def decrypt_message(self, pubkey, message, password):
        raise RuntimeError(_('UWallet and %s encryption and decryption are currently incompatible') % self.device)
...
class TrezorCompatiblePlugin(HW_PluginBase):
    ...
    def uwallet_tx_to_txtype(self, tx):
    ...
    def get_tx(self, tx_hash):
        ...
        return self.uwallet_tx_to_txtype(tx)
