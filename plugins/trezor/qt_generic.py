...
from uwallet_gui.qt.util import *
from .plugin import TIM_NEW, TIM_RECOVER, TIM_MNEMONIC
from ..hw_wallet.qt import QtHandlerBase, QtPluginBase

from uwallet.i18n import _
from uwallet.plugins import hook, DeviceMgr
from uwallet.util import PrintError, UserCancelled
from uwallet.wallet import Wallet, Standard_Wallet

PASSPHRASE_HELP_SHORT =_(
    "Passphrases allow you to access new wallets, each "
    "hidden behind a particular case-sensitive passphrase.")
PASSPHRASE_HELP = PASSPHRASE_HELP_SHORT + "  " + _(
    "You need to create a separate UWallet wallet for each passphrase "
        ...
        def toggle_passphrase():
            ...
            if currently_enabled:
                msg = _("After disabling passphrases, you can only pair this "
                        "UWallet wallet if it had an empty passphrase.  "
                        "If its passphrase was not empty, you will need to "
                        "create a new wallet with the install wizard.  You "
                        "can use this wallet again at any time by re-enabling "
                        "passphrases and entering its passphrase.")
            else:
                msg = _("Your current UWallet wallet can only be used with "
